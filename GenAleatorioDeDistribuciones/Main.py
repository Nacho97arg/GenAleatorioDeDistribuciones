...
grf.Graficas.grafHist([dist_binomial,ran.binomial(n=100,p=0.5,size=10000)], 'Binomial', autoscale=True)
grf.Graficas.grafHist([dist_poisson,ran.poisson(lam=1,size=1000)], 'Poisson', autoscale=True)
